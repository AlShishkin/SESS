...
PANEL_CONTAIN_TOL_M = 0.02  # ~2 см запас для вложенных панелей
...
def _bbox_contains(outer, inner, tol=PANEL_CONTAIN_TOL_M):
