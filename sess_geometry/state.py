...
DEFAULT_OPENING_WORK_COLS = ["id","name","category","real_width_m","real_height_m","bbox_width_m","bbox_height_m","from_room","to_room","BESS_level"]
DEFAULT_ROOM_SRC_COLS  = ["id","level","name"]
DEFAULT_AREA_SRC_COLS  = ["id","level","name"]
DEFAULT_OPENING_SRC_COLS = ["id","level","name","category","real_width_m","real_height_m","bbox_width_m","bbox_height_m","from_room","to_room"]
